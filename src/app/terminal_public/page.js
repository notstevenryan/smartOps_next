          ...
          <div className="row align-items-center g-4 position-relative z-1">
            <div className="col-12 col-lg-7">
              ...
              <div className="d-flex flex-wrap gap-2">
                <Link href="/terminal_public/01services" className="btn btn-white btn-lg rounded-pill px-4 fw-black text-primary shadow bg-white">
                  Get Started <i className="bi bi-arrow-right ms-1"></i>
                </Link>
                <Link href="/terminal_public/00arta-steps" className="btn btn-warning btn-lg rounded-pill px-4 fw-black text-dark shadow">
        ...
        <div className="row g-4">
          ...
          <div className="col-12 col-md-4">
            <div className="card h-100 border-0 shadow-sm rounded-4 p-4 bg-body text-start border-bottom border-primary border-3 transition-hover">
              ...
              <Link href="/terminal_public/01services" className="btn btn-link p-0 text-decoration-none fw-bold text-primary small mt-auto d-flex align-items-center gap-1">
          ...
          <div className="col-12 col-md-4">
            <div className="card h-100 border-0 shadow-sm rounded-4 p-4 bg-body text-start border-bottom border-warning border-3 transition-hover">
              ...
              <Link href="/terminal_public/00arta-steps" className="btn btn-link p-0 text-decoration-none fw-bold text-warning small mt-auto d-flex align-items-center gap-1">
                Open service <i className="bi bi-arrow-right"></i>
              </Link>
            </div>
          </div>
          ...
          <div className="col-12 col-md-4">
            <div className="card h-100 border-0 shadow-sm rounded-4 p-4 bg-body text-start border-bottom border-success border-3 transition-hover">
              ...
              <Link href="/terminal_public/04survey" className="btn btn-link p-0 text-decoration-none fw-bold text-success small mt-auto d-flex align-items-center gap-1">
                Open service <i className="bi bi-arrow-right"></i>
              </Link>
            </div>
          </div>
